    ...
    discordBotManager
      ...
      .then(function (bot) {
        node.on("input", async function (msg, send, done) {
          ...
          const content =
            msg.payload?.content || checkString(msg.payload) || " ";
          ...
          const createPrivateMessage = async () => {
            ...
            try {
              ...
              setSuccess(
                `message sent to ${resultMessage.channel.recipient.username}`,
                resultMessage
              );
            } catch (err) {
              setError(err);
          ...
          const createChannelMessage = async () => {
            try {
              ...
              setSuccess(
                `message sent, id = ${resultMessage.id}`,
                resultMessage
              );
            } catch (err) {
              setError(err);
          ...
          const createMessage = async () => {
            if (user) {
              ...
              setError(
                "to send messages either msg.channel or msg.user needs to be set"
              );
            }
          };
